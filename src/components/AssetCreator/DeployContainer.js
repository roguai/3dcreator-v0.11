...
const DeployContainer = () => {
    ...
    const processMintNFT = async (e) => {
        ...
        await mintNFTNEAR(
            ...
            'https://bafybeidqzowqcjinqp3uh3hanqtuwsn5j5zxaan2yujjwsmkkkrwvhnstq.ipfs.nftstorage.link/',
            window.accountId
        )
    };
    ...
    return (
        <Conatiner>
            ...
            <MainBtnGroup>
                ...
                >
                    <DeployIcon fill={deployBtn ? theme.colors.mainColor : 'rgba(255, 255, 255, 0.46)'} />
                ...
                >
                    <DownloadIcon fill={!deployBtn ? theme.colors.mainColor : 'rgba(255, 255, 255, 0.46)'} />
